...
def main():
    ...
    experiment1 = BernoulliExperiment(
        ...
        plot_filename="output/bernoulli/bias_0.5.png",
    )
    ...
    experiment2 = BernoulliExperiment(
        ...
        bias=0.1,
        exact_probability_for_alpha_value=[1, 0.95],
        plot_filename="output/bernoulli/bias_0.1.png",
    )
    ...
    non_linear_model = LinearRegression(
        data, X_map_func=np.sqrt, plot_filename="output/linear_regression/x_to_sqrt_x.png"
    )
    ...
    non_linear_model2 = LinearRegression(
        data, X_map_func=np.log, plot_filename="output/linear_regression/x_to_log_x.png"
    )
